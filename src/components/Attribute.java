...
public class Attribute {
	...
	public enum AttributeType {
		CARRIER, CARRIER_ID, CARRIER_PLAN_ID, START_DATE, END_DATE, PRODUCT_NAME, PLAN_PDF_FILE_NAME, STATE, GROUP_RATING_AREAS, SERVICE_ZONES, DEDUCTIBLE_INDIV, 
		...
		PHYSICAL_OCCUPATIONAL_THERAPY, PLAN_PDF_FILE_URL, ZERO_EIGHTEEN, NINETEEN_TWENTY, TWENTY_ONE, TWENTY_TWO, 
